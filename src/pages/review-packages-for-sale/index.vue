<template>
	<DashboardLayout>
		...
		<div v-show="showNewPackageToCreate" class="grid grid-cols-3 gap-6 mt-12">
			...
			<div class="flex flex-col gap-y-4">
				...
				<div class="flex flex-col gap-y-1">
					<div>
						...
						<p class="text-sm">The user will be able to select these options when purchasing the package.
							They
							will
							become
							tags
